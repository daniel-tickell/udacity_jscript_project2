...
if (process.env.ENV === 'test') {
    ...
    console.log(`[Database] Initializing connection pool for database: "${POSTGRES_TEST_DB}"`);
}
else {
    client = new Pool({
        host: POSTGRES_HOST,
    ...
    console.log(`[Database] Initializing connection pool for database: "${POSTGRES_DB}"`);
}
